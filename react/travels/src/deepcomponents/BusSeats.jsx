              ...
              <div>
                ...
                <div className="space-y-2">
                  <p className="flex items-center text-gray-600">
                    ...
                    <span className="font-medium">Route:</span> {bus.origin} →{" "}
                    {bus.destination}
                  </p>
                  <p className="flex items-center text-gray-600">
                    <svg
                  ...
                  <p className="flex items-center text-gray-600">
                    ...
                    >
                      <path
                        ...
                        strokeLinejoin="round"
                        strokeWidth="2"
                        d="M8 7v4a4 4 0 008 0V7m-8-3v4a4 4 0 008 0V4M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"
                      ></path>
                    </svg>
